...
import { Role, type Message } from '@/components/ui/chat-message';
...
interface ChatPropsWithSuggestions extends ChatPropsBase {
  append: (message: { role: Role.USER; content: string }) => void;
  suggestions: string[];
}
...
export function Chat({
  ...
  const isTyping = lastMessage?.role === Role.USER;
  ...
  const handleStop = useCallback(() => {
    ...
    const lastAssistantMessage = latestMessages.findLast((m) => m.role === Role.ASSISTANT);
